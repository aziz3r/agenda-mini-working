...
const ExamensTable = () => {
  ...
  const { isOpen: isSidebarOpen } = useSidebar(); // 🟩 Ajout du contexte Sidebar
  ...
  return (
    <div className="examens-table-root">
      <div className="examens-table-main">
        <div className="p-4">
                    ...
                    <tr key={exam.id} className="text-center">
                      ...
                      <td className="p-2 border">
                        {(() => {
                          ...
                          const parsed = dayjs(rawDate, "DD MMMM YYYY à HH:mm");
      ...
      {/* ✅ Sidebar */}
      {isSidebarOpen && (
        <aside className="examens-table-sidebar">
          <Sidebar />
        </aside>
      )}
    </div>
